@echo off
chcp 936 >nul
title ÔÆÖÇ - ÏÂÔØÄ£ÐÍ Í¨ÒåÇ§ÎÊ Qwen2.5-Coder  7B
cd /d "%~dp0.."

echo [95m==============================================[0m
echo [95m     ÔÆÖÇ - ÏÂÔØÄ£ÐÍ Í¨ÒåÇ§ÎÊ Qwen2.5-Coder  7B[0m
echo [95m==============================================[0m
echo.
echo  Ä£ÐÍ: Í¨ÒåÇ§ÎÊ Qwen2.5-Coder  7B
echo  ±êÇ©: qwen2.5-coder:7b
echo  ´óÐ¡: Ô¼ 4.7 GB
echo  ËµÃ÷: °¢Àï´úÂë×¨ÓÃÄ£ÐÍ
echo  ³¡¾°: ´úÂëÉú³É  ÍÆ¼ö 8GB ÄÚ´æ »ò 6GB ÏÔ´æ
echo.
echo  ÏÂÔØÔ´²ßÂÔ:
...
ollama list | findstr /I "qwen2.5-coder:7b" >nul 2>&1
if not errorlevel 1 goto already_exists

echo  µÚ 3 ²½: ¿ªÊ¼ÏÂÔØÄ£ÐÍ
echo  ÕýÔÚÀ­È¡ qwen2.5-coder:7b,Ê×´ÎÐèÏÂÔØ Ô¼ 4.7 GB
...
echo.
echo ==============================================
echo   Í¨ÒåÇ§ÎÊ Qwen2.5-Coder  7B  °²×°³É¹¦
echo ==============================================
echo.
echo  ½ÓÏÂÀ´:
...
echo  ÈçÐèÖØ×°,ÇëÏÈÖ´ÐÐ ollama rm qwen2.5-coder:7b
echo.
