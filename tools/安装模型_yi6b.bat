@echo off
chcp 936 >nul
title ÔÆÖÇ - ÏÂÔØÄ£ÐÍ ÁãÒ»ÍòÎï Yi  6B
cd /d "%~dp0.."

echo [95m==============================================[0m
echo [95m     ÔÆÖÇ - ÏÂÔØÄ£ÐÍ ÁãÒ»ÍòÎï Yi  6B[0m
echo [95m==============================================[0m
echo.
echo  Ä£ÐÍ: ÁãÒ»ÍòÎï Yi  6B
echo  ±êÇ©: yi:6b
echo  ´óÐ¡: Ô¼ 3.8 GB
echo  ËµÃ÷: Àî¿ª¸´ÁãÒ»ÍòÎï  ÖÐÓ¢ÎÄ¾ùºâ
echo  ³¡¾°: Í¨ÓÃ¶Ô»°  ÍÆ¼ö 6GB ÄÚ´æ
echo.
echo  ÏÂÔØÔ´²ßÂÔ:
...
ollama list | findstr /I "yi:6b" >nul 2>&1
if not errorlevel 1 goto already_exists

echo  µÚ 3 ²½: ¿ªÊ¼ÏÂÔØÄ£ÐÍ
echo  ÕýÔÚÀ­È¡ yi:6b,Ê×´ÎÐèÏÂÔØ Ô¼ 3.8 GB
...
echo  ÈçÐèÖØ×°,ÇëÏÈÖ´ÐÐ ollama rm yi:6b
echo.
