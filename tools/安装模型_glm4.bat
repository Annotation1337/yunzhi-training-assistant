@echo off
chcp 936 >nul
title тфжг - обтьдёпм жгфв GLM4  9B
cd /d "%~dp0.."

echo [95m==============================================[0m
echo [95m     тфжг - обтьдёпм жгфв GLM4  9B[0m
echo [95m==============================================[0m
echo.
echo  дёпм: жгфв GLM4  9B
echo  ╠Йг╘: glm4:9b
echo  ╢Сп║: т╪ 5.5 GB
echo  к╣цВ: жгфвгЕят  ╧╓╬ъ╣Всцдэа╕г©
echo  Ё║╬╟: ╧╓╬ъ╣Всц  мф╪Ж 8GB дз╢Ф ╩Р 6GB от╢Ф
echo.
echo  обтьт╢╡ъбт:
...
ollama list | findstr /I "glm4:9b" >nul 2>&1
if not errorlevel 1 goto already_exists

echo  ╣з 3 ╡╫: ©╙й╪обтьдёпм
echo  уЩтзю╜х║ glm4:9b,йв╢нпХобть т╪ 5.5 GB
...
echo  хГпХжьв╟,гКохж╢пп ollama rm glm4:9b
echo.
